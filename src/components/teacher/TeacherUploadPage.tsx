      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Tải tài liệu lên</h1>
            <p className="text-gray-600 dark:text-gray-400">
              Tải file Video, PowerPoint, Word hoặc PDF của bạn lên hệ thống để chia sẻ với học sinh
            </p>
          </div>
